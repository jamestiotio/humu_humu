...
def print_result(evalTarget, num_correct, prec, rec):
...
def compare_observed_to_predicted(observed, predicted):
    ...
    print_result("Entity", correct_entity, prec, rec)
    print()

    prec = correct_sentiment / total_predicted
    rec = correct_sentiment / total_observed
    print_result("Sentiment", correct_sentiment, prec, rec)
